...
gambar_background = Image.open("campus.jpg")
gambar_overlay = Image.open("umm.png")
...
# Handle transparency
if gambar_overlay.mode == 'RGBA':
    gambar_background.paste(gambar_overlay, (0, 0), gambar_overlay)
else:
    gambar_background.paste(gambar_overlay, (0, 0))

# TODO 5: Tambahkan teks "Informatika JOSSS!" pada gambar overlay
draw = ImageDraw.Draw(gambar_background)
font_size = 24
font = ImageFont.truetype("arial.ttf", font_size)  # Gunakan font Arial atau sesuaikan dengan font yang kamu punya
